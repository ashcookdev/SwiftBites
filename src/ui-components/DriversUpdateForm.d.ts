...
export declare type DriversUpdateFormInputValues = {
    Name?: string;
    Address?: string;
    PostCode?: string;
    SortCode?: string;
...
export declare type DriversUpdateFormValidationValues = {
...
export declare type DriversUpdateFormOverridesProps = {
    DriversUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type DriversUpdateFormProps = React.PropsWithChildren<{
    overrides?: DriversUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    drivers?: Drivers;
    onSubmit?: (fields: DriversUpdateFormInputValues) => DriversUpdateFormInputValues;
    onSuccess?: (fields: DriversUpdateFormInputValues) => void;
    onError?: (fields: DriversUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: DriversUpdateFormInputValues) => DriversUpdateFormInputValues;
    onValidate?: DriversUpdateFormValidationValues;
} & React.CSSProperties>;
export default function DriversUpdateForm(props: DriversUpdateFormProps): React.ReactElement;
