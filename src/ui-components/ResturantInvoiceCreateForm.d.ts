...
export declare type ResturantInvoiceCreateFormInputValues = {
...
export declare type ResturantInvoiceCreateFormValidationValues = {
...
export declare type ResturantInvoiceCreateFormOverridesProps = {
    ResturantInvoiceCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type ResturantInvoiceCreateFormProps = React.PropsWithChildren<{
    overrides?: ResturantInvoiceCreateFormOverridesProps | undefined | null;
} & {
    clearOnSuccess?: boolean;
    onSubmit?: (fields: ResturantInvoiceCreateFormInputValues) => ResturantInvoiceCreateFormInputValues;
    onSuccess?: (fields: ResturantInvoiceCreateFormInputValues) => void;
    onError?: (fields: ResturantInvoiceCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: ResturantInvoiceCreateFormInputValues) => ResturantInvoiceCreateFormInputValues;
    onValidate?: ResturantInvoiceCreateFormValidationValues;
} & React.CSSProperties>;
export default function ResturantInvoiceCreateForm(props: ResturantInvoiceCreateFormProps): React.ReactElement;
