...
export default function TakeAwayCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setMenu(initialValues.Menu);
    setContract(initialValues.Contract);
    setDeliverys(initialValues.Deliverys);
    setCurrentDrivers(initialValues.CurrentDrivers);
    ...
    setCurrentOutstanding(initialValues.CurrentOutstanding);
    ...
    setSalesNotes(initialValues.SalesNotes);
    setVisitTime(initialValues.VisitTime);
    setCurrentTech(initialValues.CurrentTech);
    setVisitDate(initialValues.VisitDate);
    setProspect(initialValues.Prospect);
    setSold(initialValues.Sold);
    setCity(initialValues.City);
    setCounty(initialValues.County);
    setArea(initialValues.Area);
    setMarketing(initialValues.Marketing);
    setPromoBudget(initialValues.PromoBudget);
    setErrors({});
  };
  const validations = {
    Name: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new TakeAway(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "TakeAwayCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
