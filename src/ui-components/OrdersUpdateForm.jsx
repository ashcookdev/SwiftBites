...
export default function OrdersUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setCollection(cleanValues.Collection);
    ...
    setSecurityID(cleanValues.SecurityID);
    ...
    setHotOrderPrep(cleanValues.HotOrderPrep);
    ...
    setJourneyTime(cleanValues.JourneyTime);
    setFullDeliveryTime(cleanValues.FullDeliveryTime);
    ...
    setCurrentLongValue("");
    setCustLat(cleanValues.CustLat);
    setCustLong(cleanValues.CustLong);
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Orders, idProp)
        : ordersModelProp;
