...
export declare type DriverHoursUpdateFormInputValues = {
    DriverID?: string;
    Date?: string;
    Week?: number;
    MondayBlock?: number;
...
export declare type DriverHoursUpdateFormValidationValues = {
...
export declare type DriverHoursUpdateFormOverridesProps = {
    DriverHoursUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type DriverHoursUpdateFormProps = React.PropsWithChildren<{
    overrides?: DriverHoursUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    driverHours?: DriverHours;
    onSubmit?: (fields: DriverHoursUpdateFormInputValues) => DriverHoursUpdateFormInputValues;
    onSuccess?: (fields: DriverHoursUpdateFormInputValues) => void;
    onError?: (fields: DriverHoursUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: DriverHoursUpdateFormInputValues) => DriverHoursUpdateFormInputValues;
    onValidate?: DriverHoursUpdateFormValidationValues;
} & React.CSSProperties>;
export default function DriverHoursUpdateForm(props: DriverHoursUpdateFormProps): React.ReactElement;
