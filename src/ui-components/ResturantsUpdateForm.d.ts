...
export declare type ResturantsUpdateFormInputValues = {
    Name?: string;
    Address?: string;
    Postcode?: string;
    Menu?: string;
...
export declare type ResturantsUpdateFormValidationValues = {
...
export declare type ResturantsUpdateFormOverridesProps = {
    ResturantsUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type ResturantsUpdateFormProps = React.PropsWithChildren<{
    overrides?: ResturantsUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    resturants?: Resturants;
    onSubmit?: (fields: ResturantsUpdateFormInputValues) => ResturantsUpdateFormInputValues;
    onSuccess?: (fields: ResturantsUpdateFormInputValues) => void;
    onError?: (fields: ResturantsUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: ResturantsUpdateFormInputValues) => ResturantsUpdateFormInputValues;
    onValidate?: ResturantsUpdateFormValidationValues;
} & React.CSSProperties>;
export default function ResturantsUpdateForm(props: ResturantsUpdateFormProps): React.ReactElement;
