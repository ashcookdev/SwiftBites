...
export default function InterviewSlotsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setJobOffered(initialValues.JobOffered);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new InterviewSlots(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "InterviewSlotsCreateForm")}
      {...rest}
    >
      <TextField
        label="Time"
