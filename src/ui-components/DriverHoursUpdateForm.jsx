...
export default function DriverHoursUpdateForm(props) {
  const {
    id: idProp,
    driverHours: driverHoursModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = driverHoursRecord
      ? { ...initialValues, ...driverHoursRecord }
      : initialValues;
    setDriverID(cleanValues.DriverID);
    setDate(cleanValues.Date);
    setWeek(cleanValues.Week);
    setMondayBlock(cleanValues.MondayBlock);
    setTuesdayBlock(cleanValues.TuesdayBlock);
    setWednesdayBlock(cleanValues.WednesdayBlock);
    setThursdayBlock(cleanValues.ThursdayBlock);
    setFridayBlock(cleanValues.FridayBlock);
    setSaturdayBlock(cleanValues.SaturdayBlock);
    setSundayBlock(cleanValues.SundayBlock);
    setBasicWageTotal(cleanValues.BasicWageTotal);
    setHours(cleanValues.Hours);
    setDeliverys(cleanValues.Deliverys);
    setPromo(cleanValues.Promo);
    setExtraTotal(cleanValues.ExtraTotal);
    setMondayResturant(
      typeof cleanValues.MondayResturant === "string" ||
        cleanValues.MondayResturant === null
        ? cleanValues.MondayResturant
        : JSON.stringify(cleanValues.MondayResturant)
    );
    setTuesdayResturant(
      typeof cleanValues.TuesdayResturant === "string" ||
        cleanValues.TuesdayResturant === null
        ? cleanValues.TuesdayResturant
        : JSON.stringify(cleanValues.TuesdayResturant)
    );
    setWednesdayResturant(
      typeof cleanValues.WednesdayResturant === "string" ||
        cleanValues.WednesdayResturant === null
        ? cleanValues.WednesdayResturant
        : JSON.stringify(cleanValues.WednesdayResturant)
    );
    setThursdayResturant(cleanValues.ThursdayResturant);
    setFridayResturant(cleanValues.FridayResturant);
    setSaturdayResturant(cleanValues.SaturdayResturant);
    setSundayResturant(cleanValues.SundayResturant);
    setMondayClockIns(
      typeof cleanValues.MondayClockIns === "string" ||
        cleanValues.MondayClockIns === null
        ? cleanValues.MondayClockIns
        : JSON.stringify(cleanValues.MondayClockIns)
    );
    setTuesdayClockins(
      typeof cleanValues.TuesdayClockins === "string" ||
        cleanValues.TuesdayClockins === null
        ? cleanValues.TuesdayClockins
        : JSON.stringify(cleanValues.TuesdayClockins)
    );
    setWedesdayClockins(
      typeof cleanValues.WedesdayClockins === "string" ||
        cleanValues.WedesdayClockins === null
        ? cleanValues.WedesdayClockins
        : JSON.stringify(cleanValues.WedesdayClockins)
    );
    setThursdayClockins(
      typeof cleanValues.ThursdayClockins === "string" ||
        cleanValues.ThursdayClockins === null
        ? cleanValues.ThursdayClockins
        : JSON.stringify(cleanValues.ThursdayClockins)
    );
    setFridayClockins(
      typeof cleanValues.FridayClockins === "string" ||
        cleanValues.FridayClockins === null
        ? cleanValues.FridayClockins
        : JSON.stringify(cleanValues.FridayClockins)
    );
    setSaturdayClockins(
      typeof cleanValues.SaturdayClockins === "string" ||
        cleanValues.SaturdayClockins === null
        ? cleanValues.SaturdayClockins
        : JSON.stringify(cleanValues.SaturdayClockins)
    );
    setSundayClockins(
      typeof cleanValues.SundayClockins === "string" ||
        cleanValues.SundayClockins === null
        ? cleanValues.SundayClockins
        : JSON.stringify(cleanValues.SundayClockins)
    );
    setErrors({});
  };
  const [driverHoursRecord, setDriverHoursRecord] =
    React.useState(driverHoursModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(DriverHours, idProp)
        : driverHoursModelProp;
      setDriverHoursRecord(record);
    };
    queryData();
  }, [idProp, driverHoursModelProp]);
  React.useEffect(resetStateValues, [driverHoursRecord]);
  const validations = {
    DriverID: [],
    Date: [],
    Week: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            DriverHours.copyOf(driverHoursRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "DriverHoursUpdateForm")}
      {...rest}
    >
      <TextField
        label="Driver id"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || driverHoursModelProp)}
