...
export declare type ResturantInvoiceUpdateFormInputValues = {
...
export declare type ResturantInvoiceUpdateFormValidationValues = {
...
export declare type ResturantInvoiceUpdateFormOverridesProps = {
    ResturantInvoiceUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type ResturantInvoiceUpdateFormProps = React.PropsWithChildren<{
    overrides?: ResturantInvoiceUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    resturantInvoice?: ResturantInvoice;
    onSubmit?: (fields: ResturantInvoiceUpdateFormInputValues) => ResturantInvoiceUpdateFormInputValues;
    onSuccess?: (fields: ResturantInvoiceUpdateFormInputValues) => void;
    onError?: (fields: ResturantInvoiceUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: ResturantInvoiceUpdateFormInputValues) => ResturantInvoiceUpdateFormInputValues;
    onValidate?: ResturantInvoiceUpdateFormValidationValues;
} & React.CSSProperties>;
export default function ResturantInvoiceUpdateForm(props: ResturantInvoiceUpdateFormProps): React.ReactElement;
