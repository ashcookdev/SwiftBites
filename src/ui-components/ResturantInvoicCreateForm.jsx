...
export default function ResturantInvoicCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new ResturantInvoic(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ResturantInvoicCreateForm")}
      {...rest}
    >
      <TextAreaField
