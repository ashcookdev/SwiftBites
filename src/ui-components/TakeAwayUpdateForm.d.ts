...
export declare type TakeAwayUpdateFormInputValues = {
    Name?: string;
    Address?: string;
    Postcode?: string;
    Menu?: string;
...
export declare type TakeAwayUpdateFormValidationValues = {
...
export declare type TakeAwayUpdateFormOverridesProps = {
    TakeAwayUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type TakeAwayUpdateFormProps = React.PropsWithChildren<{
    overrides?: TakeAwayUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    takeAway?: TakeAway;
    onSubmit?: (fields: TakeAwayUpdateFormInputValues) => TakeAwayUpdateFormInputValues;
    onSuccess?: (fields: TakeAwayUpdateFormInputValues) => void;
    onError?: (fields: TakeAwayUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: TakeAwayUpdateFormInputValues) => TakeAwayUpdateFormInputValues;
    onValidate?: TakeAwayUpdateFormValidationValues;
} & React.CSSProperties>;
export default function TakeAwayUpdateForm(props: TakeAwayUpdateFormProps): React.ReactElement;
