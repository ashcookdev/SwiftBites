...
import { createDeliveries } from "../mutations";
const client = generateClient();
export default function DeliveriesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createDeliveries.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "DeliveriesCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
