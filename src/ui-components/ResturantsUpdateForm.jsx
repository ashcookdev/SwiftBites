...
export default function ResturantsUpdateForm(props) {
  const {
    id: idProp,
    resturants: resturantsModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = resturantsRecord
      ? { ...initialValues, ...resturantsRecord }
      : initialValues;
  ...
  const [resturantsRecord, setResturantsRecord] =
    React.useState(resturantsModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Resturants, idProp)
        : resturantsModelProp;
      setResturantsRecord(record);
    };
    queryData();
  }, [idProp, resturantsModelProp]);
  React.useEffect(resetStateValues, [resturantsRecord]);
  const validations = {
    Name: [],
    Address: [],
    Postcode: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Resturants.copyOf(resturantsRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "ResturantsUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || resturantsModelProp)}
