...
export default function ResturantInvoiceUpdateForm(props) {
  const {
    id: idProp,
    resturantInvoice: resturantInvoiceModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = resturantInvoiceRecord
      ? { ...initialValues, ...resturantInvoiceRecord }
      : initialValues;
    setMondayDrivers(
      typeof cleanValues.MondayDrivers === "string" ||
        cleanValues.MondayDrivers === null
        ? cleanValues.MondayDrivers
        : JSON.stringify(cleanValues.MondayDrivers)
    );
    setTuesdayDrivers(
      typeof cleanValues.TuesdayDrivers === "string" ||
        cleanValues.TuesdayDrivers === null
        ? cleanValues.TuesdayDrivers
        : JSON.stringify(cleanValues.TuesdayDrivers)
    );
    setWednesdayDrivers(
      typeof cleanValues.WednesdayDrivers === "string" ||
        cleanValues.WednesdayDrivers === null
        ? cleanValues.WednesdayDrivers
        : JSON.stringify(cleanValues.WednesdayDrivers)
    );
    setThursdayDrivers(
      typeof cleanValues.ThursdayDrivers === "string" ||
        cleanValues.ThursdayDrivers === null
        ? cleanValues.ThursdayDrivers
        : JSON.stringify(cleanValues.ThursdayDrivers)
    );
    setFridayDrivers(
      typeof cleanValues.FridayDrivers === "string" ||
        cleanValues.FridayDrivers === null
        ? cleanValues.FridayDrivers
        : JSON.stringify(cleanValues.FridayDrivers)
    );
    setSaturdayDrivers(
      typeof cleanValues.SaturdayDrivers === "string" ||
        cleanValues.SaturdayDrivers === null
        ? cleanValues.SaturdayDrivers
        : JSON.stringify(cleanValues.SaturdayDrivers)
    );
    setSundayDrivers(
      typeof cleanValues.SundayDrivers === "string" ||
        cleanValues.SundayDrivers === null
        ? cleanValues.SundayDrivers
        : JSON.stringify(cleanValues.SundayDrivers)
    );
    setWeek(cleanValues.Week);
    setTotalBasic(cleanValues.TotalBasic);
    setTotalDelivery(cleanValues.TotalDelivery);
    setTotalPromo(cleanValues.TotalPromo);
    setTotalSoftware(cleanValues.TotalSoftware);
    setFullCost(cleanValues.FullCost);
    setPaid(cleanValues.Paid);
    setResturantID(cleanValues.ResturantID);
    setErrors({});
  };
  const [resturantInvoiceRecord, setResturantInvoiceRecord] = React.useState(
    resturantInvoiceModelProp
  );
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(ResturantInvoice, idProp)
        : resturantInvoiceModelProp;
      setResturantInvoiceRecord(record);
    };
    queryData();
  }, [idProp, resturantInvoiceModelProp]);
  React.useEffect(resetStateValues, [resturantInvoiceRecord]);
  const validations = {
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            ResturantInvoice.copyOf(resturantInvoiceRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "ResturantInvoiceUpdateForm")}
      {...rest}
    >
      <TextAreaField
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || resturantInvoiceModelProp)}
