...
import { Resturants } from '../backend/models'
...
const navigation = {
  ...
  pages: [
    { name: 'Driver Sign Up', href: '/driversignup' },
    { name: 'Become a SwiftBytes Take Away', href: '/sales' },
  ],
}
const favorites = [
  {
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="#">
                  <span className="sr-only">SwiftBytes</span>
                  <img
