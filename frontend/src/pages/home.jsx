...
const teams = [
  { name: 'Engineering', href: '#', initials: 'E', colorBg: 'bg-purple-600' },
  { name: 'Human Resources', href: '#', initials: 'HR', colorBg: 'bg-green-500' },
  { name: 'Customer Success', href: '#', initials: 'CS', colorBg: 'bg-yellow-500' },
]
        ...
        <main className="py-10 lg:pl-72 bg-gray-900">
          <div className="px-4 sm:px-6 lg:px-8">
            <Time />
             ...
             <div className="px-4 sm:px-6 lg:px-8 grid grid-cols-2 grid-rows-2 gap-4">
    <div>
      <DriverPortalDash />
    </div>
    <div>
