      ...
      featured: [
        {
          name: 'Margarita',
          href: '#',
          imageSrc: 'https://images.ctfassets.net/nw5k25xfqsik/64VwvKFqxMWQORE10Tn8pY/200c0538099dc4d1cf62fd07ce59c2af/20220211142754-margherita-9920.jpg',
          price: '£15',
          imageAlt: 'Margherita pizza with fresh basil, sliced tomatoes, and mozzarella cheese.',
        },
        {
          name: 'Meat Feast',
          href: '#',
          imageSrc: 'https://previews.123rf.com/images/hitforsa/hitforsa1603/hitforsa160300010/55488156-pizza-meat-feast.jpg',
          imageAlt: 'Meat pizza with pepperoni, seasoned ground beef, and bacon on top of tomato sauce and cheese.',
        },
        {
          name: 'Accessories',
          href: '#',
...
const collections = [
  {
    name: "Pizza's",
    href: '#',
    imageSrc: 'https://th.bing.com/th/id/R.c07a3ca111fcd565f5e470a7627e630c?rik=EbAlbnJiLwlmDQ&riu=http%3a%2f%2fpngimg.com%2fuploads%2fpizza%2fpizza_PNG43993.png&ehk=HXtKmWBoIhEsZqysQK8DQW%2f1okzvoTmByagXncRxoqk%3d&risl=&pid=ImgRaw&r=0',
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  <div className="flow-root">
                    <div className="-m-2 block p-2 font-medium text-white" onClick={signOut}>
                      Log Out
                    </div>
          ...
          <div className="bg-gray-900">
            <div className="mx-auto flex h-10 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex items-center space-x-6">
                ...
                <button className="-m-2 block p-2 text-sm font-medium text-gray-900" onClick={signOut}>
                      Log Out
                    </button>
